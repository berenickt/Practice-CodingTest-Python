...
첫째 줄에 8x8 좌표 평면상에서 현재 나이트가 위치한 곳의 
좌표를 나타내는 두 문자로 구성된 문자열이 입력된다. 
입력 문자는 a1 처럼 열과 행으로 이뤄진다.

input #1
a1

output #1 나이트가 이동할 수 있는 경우의 수
2
"""
...
# 현재 위치를 기준으로 아래쪽과 오른쪽은 양수, 위쪽과 왼족은 음수
# 왼쪽위부터 시계 방향
