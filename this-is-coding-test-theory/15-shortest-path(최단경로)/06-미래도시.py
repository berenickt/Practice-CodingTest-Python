...
특정 회사와 다른 회사가 연결되어 있다면, 정확히 1만큼의 시간으로 이동할 수 있다.

또한 오늘 방문 판매원 A는 기대하던 소개팅에도 참석하고자 한다.
소개팅의 상대는 K번 회사에 존재한다.
방문 판매원 A는 X번 회사에 가서 물건을 판매하기 전에, 
먼저 소개팅 상대의 회사에 찾아가서 함께 커피를 마실 예정이다.
...
e.g. N=5, X=4, K=5 이고 회사 간 도로가 7개면서, 각 도로가 다음과 같이 연결되어 있을 때를 가정할 수 있다.
...
[input #1] 1줄 - 전체 회사의 개수 N, 경로의 개수 M, 2줄 - 연결된 두 회사의 번호
5 7  
1 2
1 3
1 4
