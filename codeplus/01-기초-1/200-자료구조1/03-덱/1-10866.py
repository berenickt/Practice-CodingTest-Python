...
for _ in range(n):         
  ...
  if cmd == 'push_front':
    ...
    if d: print(d.popleft()) # 덱의 왼쪽에서 값을 빼고 출력
    else: print(-1)          # 덱이 비어있으면 -1을 출력
  elif cmd == 'pop_back':
    if d: print(d.pop())     # 덱의 오른쪽에서 값을 빼고 출력
    else: print(-1)          # 덱이 비어있으면 -1을 출력
  elif cmd == 'size':
    ...
    if d: print(d[0])        # 덱의 가장 왼쪽 값을 출력
    else: print(-1)          # 덱이 비어있으면 -1을 출력
  elif cmd == 'back':
    if d: print(d[-1])       # 덱의 가장 오른쪽 값을 출력
    else: print(-1)          # 덱이 비어있으면 -1을 출력